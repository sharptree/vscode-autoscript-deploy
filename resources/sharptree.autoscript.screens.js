        ...
        try {
            if (httpMethod.toLowerCase() === 'get') {
                ...
                if (metadata) {
                    ...
                    //Remove teh meta data from the XML so the Maximo screen parser doesn't process it.
    ...
    if (groupInfo) {
        ...
        try {
            ...
            if (groupSet.isEmpty()) {
                ...
                group.setValue('SCTEMPLATEID', scTemplateExists(groupInfo.getAttributeValue('sctemplateid')) ? groupInfo.getAttributeValue('sctemplateid') : '');
